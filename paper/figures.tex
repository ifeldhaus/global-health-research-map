...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{figures/fig2_top_funders.pdf}
  \caption{Leading funders over time, 2010--2025. Share of funded research
  articles acknowledging each of the five most frequent funders, by year.}
  \label{fig:funding}
\end{figure}
